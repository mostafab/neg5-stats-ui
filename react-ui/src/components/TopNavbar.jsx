  ...
  render() {
    return (
      <Navbar className='TopNavbar'>
        ...
        <FormGroup>
          <AsyncTypeahead delay={300} isLoading={this.props.searchingForTournaments} placeholder='Find a tournament by name or id.' align='left' promptText='Find a tournament.' minLength={3} onSearch={() => this._onSearch()} labelKey={this.labelKey}
