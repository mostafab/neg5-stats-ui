...
export default class LandingPageWrapper extends Component {
  createResultMessage() {
    ...
    if (oldStartDate && oldEndDate) {
      ...
      resultMessage = (
        <h4>
          There {len === 1 ? "is" : "are"} <b>{recentTournaments.length}</b>{" "}
          {len === 1 ? "tournament" : "tournaments"} between{" "}
          {startDateFormatted} and {endDateFormatted}
        </h4>
      );
    }
        ...
        <Grid>
          <Row>
            <Jumbotron>
              ...
              <p>
                This is the new home for all things Neg 5 stats. You can search
                for a specific tournament or find stats for past and upcoming
                tournaments below.
              </p>
