...
import {
  RECENT_TOURNAMENTS_ERROR,
  RECENT_TOURNAMENTS_RECEIVED,
  RECENT_TOURNAMENTS_REQUESTED,
  CHANGED_FOCUSED_DATE,
  CHANGED_START_OR_END_DATES,
  TOURNAMENT_SEARCH_QUERY_CHANGE,
  TOURNAMENT_SEARCH_QUERY_SUBMITTED,
  TOURNAMENT_SEARCH_QUERY_FAILURE,
  TOURNAMENT_SEARCH_QUERY_SUCCESS,
} from "./actions";
...
const initialState = {
  ...
  searchForm: {
    focusedInput: null,
    startDate: moment()
      .subtract(THREE_MONTHS_AGO, "months")
      .startOf("day")
      .valueOf(),
